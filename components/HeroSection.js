  ...
  return (
    <section className="bg-black text-white pt-14 pb-16 md:pt-24 md:pb-24 animate-fadeIn">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-7 gap-12 items-center px-6">
        ...
        {/* IMAGE MOBILE */}
        <div className="md:hidden mb-1 w-full h-64 relative border border-gray-500 rounded-xl bg-gray-800 overflow-hidden">
          <Image
            src="/hero.jpg"
        ...
        {/* IMAGE DESKTOP */}
        <div className="hidden md:block md:col-span-4 w-full h-96 relative border border-gray-500 rounded-xl bg-gray-800 overflow-hidden">
          <Image
            src="/hero.jpg"
            alt="Hero illustration"
            fill

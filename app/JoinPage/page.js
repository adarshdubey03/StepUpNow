    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white px-6 py-20">
                  ...
                  <li key={idx} className="flex items-start gap-2">
                    <span className="pt-1">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24">
                        <path d="M14 12H4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M18.586 13.603L17.619 14.364c-1.566 1.233-2.349 1.85-2.984 1.569C14 15.651 14 14.688 14 12.761v-1.522c0-1.926 0-2.89.635-3.171.635-.281 1.418.336 2.984 1.569l.967.761c.943.743 1.414 1.114 1.414 1.603 0 .488-.471.86-1.414 1.602Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </span>
                    <span>{point}</span>
                  </li>
        ...
        <div className="text-center mt-32">
          <h2 className="text-3xl font-bold mb-4">Your path is unique — your community should be too.</h2>
